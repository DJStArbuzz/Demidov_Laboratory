...
// contest
void scanf_file_contest(string fileName,
...
// tasks
void scanf_file_tasks(string fileName,
...
// student
void scanf_file_student(string fileName,
...
// compiler
void scanf_file_compiler(string fileName,
...
// all_base_info
void scanf_all_info(vector<string>& Name_number_contest,
	vector<string>& Name_tasks,
	vector<string>& Name_student,
	vector<string>& Name_compiler) 
{
